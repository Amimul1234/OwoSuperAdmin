package com.shopKPRAdmin.categoryManagement.brand.updateBrand;
...
public class UpdateBrand extends AppCompatActivity {
    ...
    private void updateCategory() {
        ...
        File file = new File(UpdateBrand.this.getCacheDir() + File.separator + filename + ".jpg");
                    ...
                    public void onResponse(@NotNull Call<ResponseBody> call, @NotNull Response<ResponseBody> response) {
                        if(response.isSuccessful())
                        {
                            try {
                                ...
                                String previousImagePath = brands.getBrandImage();

                                String cleanedAddress = previousImagePath.substring(34);

                                brands.setBrandImage(path);
                                brands.setBrandName(categoryName.getText().toString());

                                RetrofitClient.getInstance().getApi()
                                        .updateBrand(subCategoryId, brands)
                                        .enqueue(new Callback<ResponseBody>() {
                                            @Override
                                            public void onResponse(@NotNull Call<ResponseBody> call, @NotNull Response<ResponseBody> response) {
                                                if(response.isSuccessful())
                                                            ...
                                                            .enqueue(new Callback<ResponseBody>() {
                                                                ...
                                                                public void onResponse(@NotNull Call<ResponseBody> call, @NotNull Response<ResponseBody> response) {
                                                                    if(response.isSuccessful())
                                                                    {
                                                                        ...
                                                                        Toast.makeText(UpdateBrand.this, "Brand updated successfully", Toast.LENGTH_SHORT).show();

                                                                        Intent intent = new Intent(UpdateBrand.this, HomeActivity.class);
                                                                    ...
                                                                    {
                                                                        categoryUpdateProgressBar.setVisibility(View.GONE);
                                                                        Toast.makeText(UpdateBrand.this, "Failed to update brand, please try again", Toast.LENGTH_SHORT).show();
                                                                    }
                                                                }
                                            ...
                                            @Override
                                            public void onFailure(@NotNull Call<ResponseBody> call, @NotNull Throwable t) {
                                                Log.e("Update brand", "Error occurred, Error is: "+t.getMessage());
                                                categoryUpdateProgressBar.setVisibility(View.GONE);
                                                Toast.makeText(UpdateBrand.this, "Failed to update brand, please try again", Toast.LENGTH_SHORT).show();
                                            }
                                        });
                            ...
                            {
                                Log.e("Update brand", "Error occurred, Error is: "+e.getMessage());
                                categoryUpdateProgressBar.setVisibility(View.GONE);
                                Toast.makeText(UpdateBrand.this, "Failed to upload image, please try again", Toast.LENGTH_SHORT).show();
                            }
                        }
                        else
                        {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("ok", (dialog, which) -> {
                        ActivityCompat.requestPermissions(UpdateBrand.this, new String[] {Manifest.permission.READ_EXTERNAL_STORAGE}, STORAGE_PERMISSION_CODE);
                        selectImage(UpdateBrand.this);
                    })
