package com.shopKPRAdmin.categoryManagement.category;
...
public class DeleteCategoryAdapter extends RecyclerView.Adapter<DeleteCategoryAdapter.xyz>{

private final Context context;
private final List<CategoryEntity> categoryEntities;

public DeleteCategoryAdapter(Context context, List<CategoryEntity> categoryEntities) {
