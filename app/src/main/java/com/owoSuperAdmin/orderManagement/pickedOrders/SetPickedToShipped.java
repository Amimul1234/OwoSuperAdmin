...
public class SetPickedToShipped extends AppCompatActivity {
                ...
                .enqueue(new Callback<List<Shop_keeper_orders>>() {
                    ...
                    public void onResponse(@NotNull Call<List<Shop_keeper_orders>> call, @NotNull Response<List<Shop_keeper_orders>> response) {
                        if(response.isSuccessful())
                        {
                            ...
                            pickedOrderAdapter = new PickedOrderAdapter(SetPickedToShipped.this, shop_keeper_ordersList);
                            picked_order_recycler_view.setAdapter(pickedOrderAdapter);
                            picked_order_recycler_view.setLayoutManager(new LinearLayoutManager(SetPickedToShipped.this));
                            pickedOrderAdapter.notifyDataSetChanged();
                        }
                        else
                        {
                            Toast.makeText(SetPickedToShipped.this, "Error occurred...please try again", Toast.LENGTH_SHORT).show();
                            allianceLoader.setVisibility(View.INVISIBLE);
                        }
                    }
                    ...
                    public void onFailure(@NotNull Call<List<Shop_keeper_orders>> call, @NotNull Throwable t) {
                        Toast.makeText(SetPickedToShipped.this, t.getMessage(), Toast.LENGTH_SHORT).show();
                        allianceLoader.setVisibility(View.INVISIBLE);
                    }
                });
    }
