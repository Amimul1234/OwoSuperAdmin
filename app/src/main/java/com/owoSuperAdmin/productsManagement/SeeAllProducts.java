...
import com.owoSuperAdmin.ordersManagement.entity.Cart;
import com.owoSuperAdmin.owoshop.R;
import com.owoSuperAdmin.ordersManagement.viewHolders.CartViewHolder;

public class SeeAllProducts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cartListRef= FirebaseDatabase.getInstance().getReference()
                .child("Cart List").child(userID).child("Products");
    }
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter=
                new FirebaseRecyclerAdapter<Cart, CartViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull Cart model) {
                        ...
                        holder.txtProductQuantity.setText("Quantity = "+model.getNeeded_quantity());
