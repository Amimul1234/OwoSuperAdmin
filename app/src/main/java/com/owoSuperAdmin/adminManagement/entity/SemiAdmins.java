...
public class SemiAdmins implements Serializable {
    ...
    public SemiAdmins(String profileImage, String SemiAdminName, String phone, Boolean approve_shop, Boolean maintain_shops,
