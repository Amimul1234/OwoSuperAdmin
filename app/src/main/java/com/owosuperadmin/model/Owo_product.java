...
public class Owo_product implements Serializable {
    ...
    public Owo_product(String product_name, String product_category, double product_price, double product_discount, int product_quantity, String product_description, String product_creation_date, String product_creation_time, String product_sub_category, String product_brand, String product_image) {
