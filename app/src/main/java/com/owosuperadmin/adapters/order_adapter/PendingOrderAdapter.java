...
import com.owosuperadmin.shop_related.details_of_current_state.pending_order_details;
...
public class PendingOrderAdapter extends RecyclerView.Adapter<PendingOrderAdapter.ViewHolder>{
    ...
    public PendingOrderAdapter(Context mCtx, List<Shop_keeper_orders> shop_keeper_ordersList) {
        this.mCtx = mCtx;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(mCtx, pending_order_details.class);//For giving product description to the user when clicks on a cart item
