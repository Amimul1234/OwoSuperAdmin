package com.owoSuperAdmin.orderManagement.pickedOrders;
...
import com.owoSuperAdmin.orderManagement.pendingOrders.PendingOrderDetailsItemAdapter;
...
import com.owoSuperAdmin.orderManagement.processingOrders.SetProcessingToPicked;
...
public class Picked_order_details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_picked_order_details);
        ...
        confirm_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RetrofitClient.getInstance().getApi()
                        .setOrderState(order_model_class.getOrder_number(), "Shipped")
                        .enqueue(new Callback<ResponseBody>() {
                            @Override
                            public void onResponse(@NotNull Call<ResponseBody> call, @NotNull Response<ResponseBody> response) {
                                if(response.isSuccessful())
                                {
                                    Toast.makeText(Picked_order_details.this, "Order settled for shipped state", Toast.LENGTH_SHORT).show();
                                    progressBar.setVisibility(View.INVISIBLE);
                                    Intent intent = new Intent(Picked_order_details.this, SetPickedToShipped.class);
                                ...
                                {
                                    Toast.makeText(Picked_order_details.this, "Please try again", Toast.LENGTH_SHORT).show();
        ...
        cancel_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Picked_order_details.this);
                            ...
                            RetrofitClient.getInstance().getApi()
                                    ...
                                    .enqueue(new Callback<ResponseBody>() {
                                        ...
                                        public void onResponse(@NotNull Call<ResponseBody> call, @NotNull Response<ResponseBody> response) {
                                            if(response.isSuccessful())
                                            {
                                                Toast.makeText(Picked_order_details.this, "Order cancelled", Toast.LENGTH_SHORT).show();
                                                progressBar.setVisibility(View.INVISIBLE);
                                                Intent intent = new Intent(Picked_order_details.this, SetProcessingToPicked.class);
                                                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                                startActivity(intent);
                                                finish();
                                            }
