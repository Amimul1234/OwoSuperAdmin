...
public class AllDisabledShopKeeperAdapter extends PagedListAdapter<ShopKeeperUser, AllDisabledShopKeeperAdapter.ItemViewHolder>{

    private final Context mCtx;

    public AllDisabledShopKeeperAdapter(Context mCtx) {
        super(DIFF_CALLBACK);
        this.mCtx = mCtx;
    }
