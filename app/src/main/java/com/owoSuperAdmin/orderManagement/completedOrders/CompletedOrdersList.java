package com.owoSuperAdmin.orderManagement.completedOrders;
...
public class CompletedOrdersList extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(this::getCompletedOrders);
