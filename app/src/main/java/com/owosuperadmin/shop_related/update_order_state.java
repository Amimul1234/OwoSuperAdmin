...
public class update_order_state extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        Query query = cartListRef.child("Shop Keeper Orders").orderByChild("state").equalTo("Confirmed");
        ...
        FirebaseRecyclerAdapter<Order_model_class, OrderListItemViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull final OrderListItemViewHolder holder, int position, @NonNull final Order_model_class model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(update_order_state.this, confirmed_order_details.class);//For giving product description to the user when clicks on a cart item
            ...
            public void onDataChanged() {
                ...
                if(getItemCount() == 0)
                {
                    Toast.makeText(update_order_state.this, "No orders", Toast.LENGTH_SHORT).show();
                    allianceLoader.setVisibility(View.INVISIBLE);
                }
            }
        };
