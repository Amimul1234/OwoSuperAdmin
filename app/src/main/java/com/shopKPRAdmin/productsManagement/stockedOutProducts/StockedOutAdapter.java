...
import com.shopKPRAdmin.productsManagement.ProductDetailsModification;
import com.shopKPRAdmin.productsManagement.entity.OwoProduct;
import org.jetbrains.annotations.NotNull;

public class StockedOutAdapter extends PagedListAdapter<OwoProduct, StockedOutAdapter.ItemViewHolder>
{

    private final Context mCtx;

    public StockedOutAdapter(Context mCtx) {
        super(DIFF_CALLBACK);
        this.mCtx = mCtx;
    }
