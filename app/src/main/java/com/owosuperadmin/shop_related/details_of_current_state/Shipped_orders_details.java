...
public class Shipped_orders_details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                RetrofitClient.getInstance().getApi()
                        ...
                        .enqueue(new Callback<ResponseBody>() {
                            ...
                            public void onResponse(@NotNull Call<ResponseBody> call, @NotNull Response<ResponseBody> response) {
                                ...
                                {
                                    Toast.makeText(Shipped_orders_details.this, "Order settled for delivered state", Toast.LENGTH_SHORT).show();
                                    progressBar.setVisibility(View.INVISIBLE);
                                    Intent intent = new Intent(Shipped_orders_details.this, set_shipped_to_delivered.class);
                                ...
                                {
                                    Toast.makeText(Shipped_orders_details.this, "Please try again", Toast.LENGTH_SHORT).show();
        ...
        cancel_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Shipped_orders_details.this);
                            ...
                            RetrofitClient.getInstance().getApi()
                                    ...
                                    .enqueue(new Callback<ResponseBody>() {
                                        ...
                                        public void onResponse(@NotNull Call<ResponseBody> call, @NotNull Response<ResponseBody> response) {
                                            if(response.isSuccessful())
                                            {
                                                Toast.makeText(Shipped_orders_details.this, "Order cancelled", Toast.LENGTH_SHORT).show();
                                                progressBar.setVisibility(View.INVISIBLE);
                                                Intent intent = new Intent(Shipped_orders_details.this, pending_orders.class);
                                                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                                startActivity(intent);
                                                finish();
                                            }
