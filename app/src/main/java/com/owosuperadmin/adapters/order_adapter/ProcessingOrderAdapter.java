package com.owosuperadmin.adapters.order_adapter;
...
import com.owosuperadmin.shop_related.details_of_current_state.Processing_orders_details;
import java.util.List;

public class ProcessingOrderAdapter extends RecyclerView.Adapter<ProcessingOrderAdapter.ViewHolder>{

    private Context mCtx;
    private List<Shop_keeper_orders> shop_keeper_ordersList;

    public ProcessingOrderAdapter(Context mCtx, List<Shop_keeper_orders> shop_keeper_ordersList) {
        this.mCtx = mCtx;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ProcessingOrderAdapter.ViewHolder(view);
    }
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(mCtx, Processing_orders_details.class);//For giving product description to the user when clicks on a cart item
