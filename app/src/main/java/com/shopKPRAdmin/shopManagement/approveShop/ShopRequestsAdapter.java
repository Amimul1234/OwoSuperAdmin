package com.shopKPRAdmin.shopManagement.approveShop;
...
import com.shopKPRAdmin.utilities.NetworkState;
import org.jetbrains.annotations.NotNull;

import de.hdodenhof.circleimageview.CircleImageView;

public class ShopRequestsAdapter extends PagedListAdapter<Shops, RecyclerView.ViewHolder> {
    ...
    public ShopRequestsAdapter(Context mCtx) {
        super(DIFF_CALLBACK);
        this.mCtx = mCtx;
    }
