...
import com.owosuperadmin.owoshop.AddProductActivity;
...
import com.owosuperadmin.owoshop.CreateOffersActivity;
import com.owosuperadmin.shopManagement.ManageRegisteredShops;
import com.owosuperadmin.owoshop.ProductAvailabilityActivity;
import com.owosuperadmin.owoshop.QuponActivity;
...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.xyz>{
    ...
    public HomeAdapter(Context context) {
        ...
        segment = context.getResources().getStringArray(R.array.home);
        icons = new int[] {R.drawable.home1,R.drawable.home2,R.drawable.home3,R.drawable.home4,
    ...
    private void takeNecessaryActions(int position) {
        ...
        else if (position==4)
        {
            ...
            available_products.setOnClickListener(v -> {
                Intent intent=new Intent(context, ProductAvailabilityActivity.class);
                context.startActivity(intent);
                alertDialog.cancel();
            });
