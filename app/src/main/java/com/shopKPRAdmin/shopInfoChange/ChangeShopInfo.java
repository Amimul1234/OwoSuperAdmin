...
public class ChangeShopInfo implements Serializable {
    ...
    public ChangeShopInfo(Long changeShopInfoId, String shopOwnerMobileNumber,
                          String newShopImageURL, String newShopName, String newShopAddress,
                          String newShopOwnerName, String newShopServiceMobile, String newShopOwnerNidFront,
                          String newShopTradeLicenseURI)
    {
