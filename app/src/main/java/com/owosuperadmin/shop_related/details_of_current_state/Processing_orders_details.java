...
public class Processing_orders_details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirm_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RetrofitClient.getInstance().getApi()
                        .setOrderState(order_model_class.getOrder_number(), "Picked")
                        .enqueue(new Callback<ResponseBody>() {
                            @Override
                            public void onResponse(@NotNull Call<ResponseBody> call, @NotNull Response<ResponseBody> response) {
                                if(response.isSuccessful())
                                {
                                    Toast.makeText(Processing_orders_details.this, "Order settled for picked state", Toast.LENGTH_SHORT).show();
                                    progressBar.setVisibility(View.INVISIBLE);
                                    Intent intent = new Intent(Processing_orders_details.this, set_processing_to_picked.class);
                                ...
                                {
                                    Toast.makeText(Processing_orders_details.this, "Please try again", Toast.LENGTH_SHORT).show();
        ...
        cancel_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Processing_orders_details.this);
                            ...
                            RetrofitClient.getInstance().getApi()
                                    ...
                                    .enqueue(new Callback<ResponseBody>() {
                                        ...
                                        public void onResponse(@NotNull Call<ResponseBody> call, @NotNull Response<ResponseBody> response) {
                                            if(response.isSuccessful())
                                            {
                                                Toast.makeText(Processing_orders_details.this, "Order cancelled", Toast.LENGTH_SHORT).show();
                                                progressBar.setVisibility(View.INVISIBLE);
                                                Intent intent = new Intent(Processing_orders_details.this, set_processing_to_picked.class);
                                                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                                startActivity(intent);
