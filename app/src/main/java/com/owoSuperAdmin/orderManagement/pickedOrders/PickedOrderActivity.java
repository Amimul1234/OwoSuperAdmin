...
public class PickedOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_picked_order_activity);
        ...
        confirm_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                order_model_class.setState("Picked");
                ...
                databaseReference.child("Shop Keeper Orders").child(order_model_class.getOrder_number()).setValue(order_model_class).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(PickedOrderActivity.this, "Order state Updated", Toast.LENGTH_SHORT).show();
                        progressBar.setVisibility(View.VISIBLE);
                        finish();
                    }
