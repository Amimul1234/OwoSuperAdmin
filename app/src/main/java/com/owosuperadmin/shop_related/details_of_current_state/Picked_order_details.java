package com.owosuperadmin.shop_related.details_of_current_state;
...
public class Picked_order_details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Shop_keeper_ordered_products> shop_keeper_ordered_productsList = order_model_class.getShop_keeper_ordered_products();
                        ...
                        .enqueue(new Callback<ResponseBody>() {
                            ...
                            public void onResponse(@NotNull Call<ResponseBody> call, @NotNull Response<ResponseBody> response) {
                                if(response.isSuccessful())
                                {
                                    ...
                                    Intent intent = new Intent(Picked_order_details.this, set_picked_to_shipped.class);
                                    ...
                                    .enqueue(new Callback<ResponseBody>() {
                                        ...
                                        public void onResponse(@NotNull Call<ResponseBody> call, @NotNull Response<ResponseBody> response) {
                                            if(response.isSuccessful())
                                            {
                                                ...
                                                progressBar.setVisibility(View.INVISIBLE);
                                                Intent intent = new Intent(Picked_order_details.this, set_processing_to_picked.class);
                                                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                                startActivity(intent);
                                                finish();
                                            }
