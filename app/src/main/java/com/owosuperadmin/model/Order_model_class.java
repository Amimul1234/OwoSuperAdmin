...
public class Order_model_class implements Serializable{
    ...
    public Order_model_class() {
    }

    public Order_model_class(String additional_comments, String delivery_method, double coupon_discount, String date, String delivery_address, String name, String order_number, List<Ordered_products> product_ids, String receiver_phone, String shop_number, String state, String time, String totalAmount) {
