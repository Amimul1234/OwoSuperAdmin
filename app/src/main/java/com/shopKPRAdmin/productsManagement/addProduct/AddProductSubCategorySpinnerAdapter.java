package com.shopKPRAdmin.productsManagement.addProduct;
...
public class AddProductSubCategorySpinnerAdapter extends BaseAdapter {
    Context context;
    List<SubCategoryEntity> subCategoryEntityList;
    LayoutInflater inflater;

    public AddProductSubCategorySpinnerAdapter(Context context, List<SubCategoryEntity> subCategoryEntityList) {
